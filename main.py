...
def update_gui(stateData:np.ndarray, serialActive:list[bool], _gui_closed:bool):
    ...
    while not _gui_closed[0]:
        ...
        # absEncCurrentVelocityFR = states[4]
        # absEncCurrentVelocityFL = states[5]
        # absEncCurrentVelocityBR = states[6]
        # absEncCurrentVelocityBL = states[7]
        quadEncoderVel = states[8]
        pitch_local = states[9]
        roll_local = states[10]
        yaw_local = states[11]
        # accelerationZ = states[12]
        # gyroRoll = states[13]
        # gyroPitch = states[14]
        steeringAngle = states[15]
        # print(states)
        ...
        print(pitch_local, roll_local, yaw_local)
